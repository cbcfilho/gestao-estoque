...
São 100 verificações cobrindo FEFO, custo médio ponderado, saldo em trânsito,
...
idempotência do cron, imutabilidade das movimentações e recebimento de produto
via XML de NF-e (dedup por chave de acesso, casamento por EAN, divergência de
